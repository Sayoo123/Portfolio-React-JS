  ...
  return (
    <motion.div className='max-w-[1400px] h-[780px] w-full m-auto py-16 px-4 relative group ' variants={textVariant()}>
      ...
      >
          ...
          <div className={`${currentIndex===1?'mt-0':'mt-16'} flex flex-row sm-phone7`}>
            <div className='w-6/12 ml-5 mt-10'>
              ...
              <motion.p variants={fadeIn("", "", 0.1, 1)} className={`text-secondary text-[17px] max-w-3xl leading-[30px] text-white sm-phone8`}>{slides[currentIndex].content}<br/><strong>Frontend :{slides[currentIndex].frontend}</strong><br/><strong>Backend :{slides[currentIndex].backend}</strong><br/><strong>Database :{slides[currentIndex].database}</strong></motion.p>
